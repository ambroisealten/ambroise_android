...
public class ApplicantForum implements Parcelable {
    ...
    public String toString() {
        return new StringBuilder()
                ...
                .append(getString(R.string.contract)).append(": ").append(startAt).append(System.lineSeparator())
                ...
                .append(getString(R.string.has_vehicle)).append(" ").append(vehicule).append("; ").append(getString(R.string.driving_license)).append(" ").append(driverLicense).append(System.lineSeparator())
